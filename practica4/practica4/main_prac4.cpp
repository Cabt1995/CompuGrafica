...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glLoadIdentity();
		...
		glPushMatrix();//mano izquierda
			glTranslated(-3.6, .51, 0);
			glScalef(.3, .3, 1.25);
			prisma();
		glPopMatrix();
		
		glPushMatrix();//ante brazo izquierda
			glTranslated(-2.92, .51, 0);
			glScalef(1, .3, 1.25);
			prisma();
		glPopMatrix();

		glPushMatrix();//bicep izquierda
			glTranslated(-1.675, .51, 0);
			glScalef(1.3, .3, 1.25);
			prisma();
		glPopMatrix();

		glPushMatrix();//mano derecho
		glTranslated(3.6, .51, 0);
		glScalef(.3, .3, 1.25);
		prisma();
		glPopMatrix();

		glPushMatrix();//ante brazo derecho
		glTranslated(2.92, .51, 0);
		glScalef(1, .3, 1.25);
		prisma();
		glPopMatrix();
